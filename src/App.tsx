...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F8FAFC] font-sans text-slate-900 antialiased selection:bg-primary selection:text-white" dir="rtl">
      <Header profile={profile} isOnline={navigator.onLine} onRefresh={() => window.location.reload()} onSignOut={handleSignOut} onNavigate={setActiveTab} />
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="mx-auto w-full max-w-7xl flex-1 overflow-y-auto p-4 pb-24 md:p-6 md:pb-8 lg:p-8">
          ...
          {activeTab === 'account_security' && <AccountSecurityPage profile={profile} onProfileUpdated={setProfile} onSignOut={handleSignOut} />}
        </main>
      </div>
